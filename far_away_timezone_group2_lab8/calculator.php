...
<div id="container">
	...
	<form name="calc" method="post" action="calculator.php" id="calculator">
		...
		<input type="button" value=" clean all " class="clean" onclick="calc.op1.value = ''" />

		<br/>

		<p class="vp">Second number(if needed)</p>
		...
		<input type="button" value=" clean all " class="clean" onclick="calc.op2.value = ''" />
